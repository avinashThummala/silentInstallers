...
public class SilentProbeInstaller extends javax.swing.JFrame
{
    ...
    public static void main(String args[]) 
    {
        ...
        {
        	ex.printStackTrace();
            java.util.logging.Logger.getLogger(SilentProbeInstaller.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(new Runnable() {

            public void run() {
                new SilentProbeInstaller();
            }
        });
